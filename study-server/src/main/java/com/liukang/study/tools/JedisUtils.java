...
public class JedisUtils {
	...
	public static final String KEY_PREFIX = Constant.PROJECT_NAME + "-portal:";
	...
	public static <T> T getJsonObject(String key,Class<T> cls) {
		String json = get(key);
		...
		Object value = JsonMapper.fromJsonString(json, cls);
	 ...
	 * @return
	 */
	public static String setJsonObject(String key, Object value, int cacheSeconds) {
		String json = JsonMapper.toJsonString(value);
		return set(key, json, cacheSeconds);
	}
